...
[![Package](https://img.shields.io/gem/v/known-errors)](https://rubygems.org/gems/known-errors)
[![Documentation](https://img.shields.io/badge/rubydoc-latest-blue)](https://rubydoc.info/gems/known-errors)

Well-known errors for Ruby.

## 👉 Examples

### Importing well-known errors

```ruby
require 'known/errors'
```
